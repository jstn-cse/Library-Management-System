...
public class Librarian_UI extends javax.swing.JFrame {
    ...
    public Librarian_UI() {
        initComponents();
         ...
         Timer refreshTimer = new Timer(delay, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                dashboardIssuedBooksDetails();
                dashboardDefaulterListDetails();
                 fetchReports();
             }
         });
          refreshTimer.start();
        ...
        ManageUserTab.setVisible(false);
...
// Insert Book Details in DASHBOARD
    ...
    // Insert Book Details in DASHBOARD
    public void dashboardIssuedBooksDetails() {
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/lms", "root", "");
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery("SELECT * FROM issuedbooks");
            DefaultTableModel dashboardIssuedBookDetails = (DefaultTableModel) IssuedList_Table2.getModel();
            dashboardIssuedBookDetails.setRowCount(0);
            int bookCount = 0;
            while (rs.next()) {
            bookCount++;
            Object[] row = {
            ...
            dashboardIssuedBookDetails.addRow(row);
        }
            Dashboard_IssuedBooks.setText(String.valueOf(bookCount));
            rs.close();
            st.close();
        } catch (Exception e) {
            e.printStackTrace(); // Handle exceptions appropriately
        ...
        // Insert Book Details in DASHBOARD
    private void dashboardDefaulterListDetails() {
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/lms", "root", "");
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery("SELECT * FROM returnedbooks");
        // Clear existing rows from the table
        DefaultTableModel dashboardReturnedBooksDetails = (DefaultTableModel) ReturnedBooks_Table.getModel();
        dashboardReturnedBooksDetails.setRowCount(0);
        int bookCount = 0;
        while (rs.next()) {
            bookCount++;
            Object[] row = {
            ...
            dashboardReturnedBooksDetails.addRow(row);
        }
            DashBoard_DefaulterCount.setText(String.valueOf(bookCount));
            rs.close();
            st.close();
        } catch (Exception e) {
            e.printStackTrace(); // Handle exceptions appropriately
    ...
    public void getBorrowerDetails() {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                JOptionPane.showMessageDialog(null, "Studenr ID Cannot be found.");
            }
...
// Insert the DATABASE TO DEFAULTER LIST JTABLE
        ...
        public void getDefaulterDetails() {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, "Invalid Student ID. Please enter a Student ID.");
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
...
//Basically a Clock
                ...
                public void run() {
                   while (true){
                    try {
                        ...
                        Logger.getLogger(Librarian_UI.class.getName()).log(Level.SEVERE, null, ex);
                    }
                    Date date = new Date();
    ...
    private void initComponents() {
        ...
        DashBoard_DefaulterCount = new javax.swing.JLabel();
        ...
        Dashboard_IssuedBooks = new javax.swing.JLabel();
        ...
        SwitchToAdmin = new javax.swing.JButton();
        ...
        jPanel12.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 30, 140, 40));
        ...
        jPanel12.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, 70, 70));

        DashBoard_DefaulterCount.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        DashBoard_DefaulterCount.setForeground(new java.awt.Color(255, 255, 255));
        DashBoard_DefaulterCount.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        DashBoard_DefaulterCount.setText("0");
        jPanel12.add(DashBoard_DefaulterCount, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 70, 110, 40));
        ...
        Dashboard_IssuedBooks.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        Dashboard_IssuedBooks.setForeground(new java.awt.Color(255, 255, 255));
        Dashboard_IssuedBooks.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        Dashboard_IssuedBooks.setText("0");
        jPanel13.add(Dashboard_IssuedBooks, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 70, 110, 40));
        ...
        txt_searchBy.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Book ID", "Book Title", "Author", "Category", "Year", "Qty" }));
        ...
        txt_booksection.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ICT", "ABM", "Science", "Psychology", "Law", "Math", "Research", "Philosophy" }));
        ...
        jPanel18.add(addStudent_button, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 490, 60, 20));
        ...
        jPanel18.add(Delete_button1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 490, 70, 20));
        ...
        jPanel18.add(Update_button1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 490, 70, 20));
        ...
        user_Category.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Student ID", "Student Name", "Section", "Strand", "Email", "Mobile No.", "Address" }));
        ...
        jPanel16.add(txt_searchUser, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 20, 190, -1));
        ...
        jPanel20.add(BorrowerList_JScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 50, 1020, 350));
        ...
        jPanel20.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 440, 80, 20));
        ...
        user_Category3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Name", "ID", "Student ID", "Issue Date", "Due Date", "Book ID", "Book Title" }));
        ...
        jPanel20.add(tf_bookid, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 510, 140, 30));
        ...
        jPanel20.add(tf_id, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 460, 140, 30));
        ...
        jPanel20.add(tf_name, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 460, 140, 30));
        ...
        tf_studentid.setPlaceholder("Student ID");
        jPanel20.add(tf_studentid, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 560, 140, 30));
        ...
        jPanel20.add(tf_issuedate, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 560, 140, 30));
        ...
        jPanel20.add(tf_duedate, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 560, 140, 30));
        ...
        jPanel20.add(tf_booktitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 510, 140, 30));
        ...
        jPanel20.add(tf_qty, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 460, 140, 30));
        ...
        jPanel20.add(tf_status, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 510, 140, 30));
        ...
        jPanel7.add(jLabel69, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 160, 80, 20));

        jLabel70.setFont(new java.awt.Font("Century Gothic", 0, 10)); // NOI18N
        jLabel70.setForeground(new java.awt.Color(255, 255, 255));
        jLabel70.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel70.setText("Student ID");
        jPanel7.add(jLabel70, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 160, 80, 20));

        jLabel71.setFont(new java.awt.Font("Century Gothic", 0, 10)); // NOI18N
        jLabel71.setForeground(new java.awt.Color(255, 255, 255));
        jLabel71.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel71.setText("Book Title");
        jPanel7.add(jLabel71, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 160, 80, 20));

        jLabel72.setFont(new java.awt.Font("Century Gothic", 0, 10)); // NOI18N
        jLabel72.setForeground(new java.awt.Color(255, 255, 255));
        jLabel72.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel72.setText("Issue Date");
        jPanel7.add(jLabel72, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 110, 80, 20));

        jLabel73.setFont(new java.awt.Font("Century Gothic", 0, 10)); // NOI18N
        jLabel73.setForeground(new java.awt.Color(255, 255, 255));
        jLabel73.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel73.setText("Due Date");
        jPanel7.add(jLabel73, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 110, 80, 20));

        jLabel74.setFont(new java.awt.Font("Century Gothic", 0, 10)); // NOI18N
        jLabel74.setForeground(new java.awt.Color(255, 255, 255));
        jLabel74.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel74.setText("Book ID");
        jPanel7.add(jLabel74, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 110, 80, 20));

        jLabel75.setFont(new java.awt.Font("Century Gothic", 0, 10)); // NOI18N
        jLabel75.setForeground(new java.awt.Color(255, 255, 255));
        jLabel75.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel75.setText("Record ID");
        jPanel7.add(jLabel75, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 60, 80, 20));

        jLabel76.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        jLabel76.setForeground(new java.awt.Color(255, 255, 255));
        jLabel76.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel76.setText("Student Details");
        jPanel7.add(jLabel76, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 10, 110, 30));

        jLabel77.setFont(new java.awt.Font("Century Gothic", 0, 10)); // NOI18N
        jLabel77.setForeground(new java.awt.Color(255, 255, 255));
        jLabel77.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel77.setText("Quantity:");
        jPanel7.add(jLabel77, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 60, 80, 20));
        ...
        jPanel7.add(txt_id, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 80, 160, 30));
        ...
        jPanel7.add(txt_issuedate, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 130, 160, 30));
        ...
        jPanel7.add(txt_quantity2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 80, 160, 30));
        ...
        jPanel7.add(txt_duedate, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 130, 160, 30));
        ...
        jPanel7.add(txt_fullname, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 80, 160, 30));
        ...
        jPanel7.add(txt_bookid, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 130, 160, 30));
        ...
        jPanel7.add(defaulterList_search, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 220, 80, 20));
        ...
        jPanel7.add(txt_title, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 180, 160, 30));
        ...
        txt_studentid2.setPlaceholder("Student ID");
        txt_studentid2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txt_studentid2KeyReleased(evt);
            }
        });
        jPanel7.add(txt_studentid2, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 180, 160, 30));
        ...
        jPanel7.add(txt_status, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 180, 160, 30));
        ...
        jPanel7.add(cancel_button1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 220, 80, 20));
        ...
        jPanel7.add(jLabel78, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 60, 80, 20));

        jPanel10.add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 10, 640, 250));
        ...
        jPanel10.add(jLabel55, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 190, 60));
        ...
        SwitchToAdmin.setBackground(new java.awt.Color(5, 21, 40));
        SwitchToAdmin.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        SwitchToAdmin.setForeground(new java.awt.Color(255, 255, 255));
        SwitchToAdmin.setText("Admin");
        SwitchToAdmin.setBorder(null);
        SwitchToAdmin.setContentAreaFilled(false);
        SwitchToAdmin.setOpaque(true);
        SwitchToAdmin.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SwitchToAdminActionPerformed(evt);
            }
        });
        Settings_Panel.add(SwitchToAdmin, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 80, 20));
        ...
        Settings_Panel.add(Logout_button, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, 80, 20));

        SideTab.add(Settings_Panel, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 600, 80, 80));
        ...
        SideTab.add(ManageBooksTab, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 480, 230, 40));
        ...
        SideTab.add(ManageUserTab, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 580, 230, 40));
        ...
        SideTab.add(IssueBooksTab, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 280, 230, 40));
        ...
        SideTab.add(Records, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 330, 230, 40));
        ...
        SideTab.add(ReturnedBooksTab, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 380, 230, 40));
        ...
        SideTab.add(DefaulterTab, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 430, 230, 40));
        ...
        SideTab.add(ReportsTab, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 530, 230, 40));
    ...
    private void SwitchToAdminActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SwitchToAdminActionPerformed
    try {
        // Establish database connection
        Class.forName("com.mysql.cj.jdbc.Driver");
        Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/lms", "root", "");

        // Query to fetch the password of the admin user
        String query = "SELECT password FROM users WHERE role = 'admin' AND email = 'admin'";
        try (PreparedStatement pst = con.prepareStatement(query)) {
            ResultSet rs = pst.executeQuery();
            if (rs.next()) {
                String adminPassword = rs.getString("password");

                // Prompt for password with echoChar set to '*'
                JPasswordField passwordField = new JPasswordField();
                int option = JOptionPane.showConfirmDialog(null, passwordField, "Enter password to access Admin UI:", JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE);
                if (option == JOptionPane.OK_OPTION) {
                    char[] inputPassword = passwordField.getPassword();

                    // Validate the password
                    if (inputPassword != null && new String(inputPassword).equals(adminPassword)) {
                        Settings_Panel.setVisible(false);
                ...
                JOptionPane.showMessageDialog(this, "Admin account not found.");
            }
        }
        con.close();
    } catch (Exception e) {
    ...
    }//GEN-LAST:event_SwitchToAdminActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Librarian_UI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton SwitchToAdmin;
